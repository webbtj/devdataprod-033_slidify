...
We then report the predicted likelihood that this is a manual transmission ``r paste0(format(am.prediction*100, trim=TRUE, digits=4), '%')`` and the predicted fuel economy ``r paste0(format(mpg.prediction, trim=TRUE, digits=3), 'mpg')``
